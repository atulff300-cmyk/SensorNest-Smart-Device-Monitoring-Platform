...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Delay redirect slightly so user can see the popup
      setTimeout(() => {
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 selection:bg-cyan-500 selection:text-black">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400 mt-2">Log in to your SensorNest dashboard.</p>
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
          ...
          <div className="mt-6 text-center text-sm text-zinc-500">
            Don't have an account? <Link href="/signup" className="text-white hover:text-cyan-400 transition-colors">Sign Up</Link>
          </div>
        </div>
